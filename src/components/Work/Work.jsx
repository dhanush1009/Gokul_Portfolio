      ...
      <div className="shell">
        ...
        <div className="work-carousel-line">
          <VideoCarousel
            ...
            variant="horizontal"
            // label="Line 01 — Horizontal Films (16:9)"
            // description="Cinematic widescreen cuts, branded narratives, and color finishing."
          />
        </div>
        ...
        <div className="work-carousel-line" style={{ marginTop: '70px' }}>
          <VideoCarousel
            ...
            // description="High-energy mobile stories, reels, TikTok, and social campaigns."
          />
        </div>
      </div>
    </section>
